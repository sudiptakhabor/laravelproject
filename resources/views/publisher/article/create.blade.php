    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="card">
                ...
                <form class="needs-validation" novalidate action="{{ URL::route('publisher.'.$url.'.store') }}" method="post" enctype="multipart/form-data">
                @csrf
                    ...
                    <button type="submit" name="submit" class="btn btn-primary" value = "save">Publish</button>
