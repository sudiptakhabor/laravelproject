                        ...
                        <tbody>
                          @foreach( $rows as $key => $row ) 
                            <tr>
								...
								<td>
								<?php  
									if(!isset($row->review_date[0]->review_last_date) || is_null($row->review_date[0]->review_last_date) || $row->review_date[0]->review_last_date == 0)
									{
										echo "NA";
									}else{
										echo date('d M, Y', strtotime($row->review_date[0]->review_last_date));
									} 
								?>
								</td>
                                <td>
