    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="card">
                ...
                <form class="needs-validation" novalidate action="{{ URL::route('editor.'.$url.'.store') }}" method="post" enctype="multipart/form-data">
                @csrf
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control summernote" name="abstracts" id="abstracts" rows="8"></textarea>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="coauther" id="coauther" placeholder="Co-Auther">
                    ...
                    <button type="submit" name="submit" class="btn btn-primary" value = "save">Submit for Revision</button>
